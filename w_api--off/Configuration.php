...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '7bfcebb363c93556f6e8dd89d0f9a4798eaf69454cabc427cf0991daacdc5778';
	const ERROR_REPORTING_LEVEL = '0';
	const DEPLOYED_HOSTNAME = 'bonicholslaw.com';
	const CLOUD_HOSTNAME = 'pages.weeblycloud.com';
	const DEPLOYED_HOSTNAME_HEADER = 'X-W-Cloud-Host';
	const BUILDDATE = '1715398584';
