			...
			<div class="main-slider-carousel owl-carousel owl-theme">
				...
				<div class="slide ban-slide-1">
					...
					<div class="auto-container">
						...
						<!-- Content boxed -->
						<div class="content-boxed my-txttt" style="font-size: 40px !important; ">
							<h1>Your Trusted <br> Family Law Advocate <br> in Houston</h1>
				...
				<div class="row clearfix">
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="text-my">Bo Nichols Law – Best Family Lawyer in Houston, Texas<br><br><span
									class="theme-color">Why Choose Us?</span></div>
							<br>
							<div class="featured-block">
								<div class="block-inner">
									<span class="icon flaticon-courthouse"></span>
									<strong>Emotional and legal complexities in family law cases.
									</strong>
								</div>
							</div>
							<br>
							...
							<div class="featured-block">
								<div class="block-inner">
									...
									<strong>The best lawyers in Houston, Texas.
							...
							<div class="featured-block">
								<div class="block-inner">
									...
									<strong>Ensure your rights are protected and your voice is heard
									</strong>
								</div>
							</div>
							<br>
							<div class="text-my theme-color" style="font-style:italic; font-weight:500">Best for the
								best divorce lawyer, a compassionate child custody lawyer, or an aggressive advocate in
								a high-stakes family dispute
							</div>
						</div>
					</div>
								...
								<div class="single-item-carousel owl-carousel owl-theme">
									...
									<div class="testimonial-block-two">
										<div class="inner-box">
											...
											<div class="quote-icon flaticon-right-quote"></div>
											<div class="text">BO IS THE BEST! He’s blunt but brilliant! He saved my case
												after my first attorney failed to resolve what should have been a
												simple divorce with a difficult ex. My ex ended up representing herslef
												pro se. Bo was a master in handling her. IF BO TALKS - SHUT UP AND
												LISTEN - he has your back. HIGHLY REC...</div>
										</div>
									</div>
									<div class="testimonial-block-two">
										<div class="inner-box">
		...
		<section class="pricing-section">
			...
			<div class="auto-container">
				...
				<div class="sec-title light centered">
					<h2>Contact Houston’s Premier Family Law Firm</h2>
				</div>
				<div class="paragraph-container">
					<p class="text-high text-white text-center"></p>
					<p class="text text-white text-center">When you need a trusted advocate for your family legal
						matters, Bo Nichols Law is here to help. As one of the best lawyers in Houston, Texas, Bo will
						help you reclaim peace and clarity during some of life’s most difficult transitions.
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12 text-container">
						<div class="inner-column">
							...
							<!-- <div class="text theme-color">John “Bo” Nichols is no stranger to the practice of Family
								Law.</div> -->
							<br>
							<div class="text">Bo is widely recognized as one of the best divorce lawyers in Houston,
								with a legal career spanning nearly three decades. A proud graduate of South Texas
								College of Law, Bo began practicing in 1996 and has been admitted to practice in
								multiple Texas courts, including the Texas Supreme Court and United States District
